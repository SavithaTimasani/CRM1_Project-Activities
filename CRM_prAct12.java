...
public class CRM_prAct12 {
  ...
  public void ReadPopup() throws Exception {
		...
		search_first_name.sendKeys("dinesh");
		...
		WebElement meeting=driver.findElement(By.xpath("//a[contains(text(),'SAVI_Meet1')]"));
