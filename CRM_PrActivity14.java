...
public class CRM_PrActivity14 {
	WebDriver driver;
	WebDriverWait wait;
	
  @Test
  public void ReadPopupFilter() throws Exception {
		...
		Select sales=new Select(driver.findElement(By.id("sales_stage_advanced")));
		sales.selectByValue("Prospecting");
		sales.selectByValue("Needs Analysis");
		sales.selectByValue("Proposal/Price Quote");
